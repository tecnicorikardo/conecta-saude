...
import '../../features/channels/presentation/pages/channel_detail_page.dart';
import '../../features/channels/domain/entities/channel_entity.dart';
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return ChannelDetailPage(channelId: id, channel: channel);
        },
      ),
      GoRoute(
        path: AppRoutes.chat,
